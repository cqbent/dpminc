...
function animate_down() {
	$("#t11").delay(1000).animate( { top: "370px", fontSize: "22px", left: "0px" }, 1000 );
	$("#t12").delay(1000).animate( { top: "370px", fontSize: "22px", left: "200px" }, 1000 );
	$("#t13").delay(1000).animate( { top: "370px", fontSize: "22px", left: "320px" }, 1000 );
	$("#t21").delay(1000).animate( { top: "400px", fontSize: "22px", left: "0px" }, 1000 );
	$("#t22").delay(1000).animate( { top: "400px", fontSize: "22px", left: "175px" }, 1000 );
	$("#t23").delay(1000).animate( { top: "400px", fontSize: "22px", left: "360px" }, 1000 );
	$('#introtext').delay(3000).queue( function() { animate_industries('go'); } ); 
}

function animate_down_alt() {
	$("#t11").delay(1000).animate( { top: "280px", fontSize: "22px", left: "0px" }, 1000 );
	$("#t12").delay(1000).animate( { top: "280px", fontSize: "22px", left: "200px" }, 1000 );
	$("#t13").delay(1000).animate( { top: "280px", fontSize: "22px", left: "320px" }, 1000 );
	$("#t21").delay(1000).animate( { top: "310px", fontSize: "22px", left: "0px" }, 1000 );
	$("#t22").delay(1000).animate( { top: "310px", fontSize: "22px", left: "175px" }, 1000 );
	$("#t23").delay(1000).animate( { top: "310px", fontSize: "22px", left: "360px" }, 1000 );
	$('#introtext').delay(3000).queue( function() { animate_industries('go'); } ); 
}
...
function animate_industries(status) {
	...
	if(status == 'stop') {
		...
		$('.container').queue(function() { show_industry('corporate'); $('#middle').delay(1000).addClass('complete');
$(this).dequeue(); } );
		$('.container').delay(3000).queue(function() { show_industry('academic'); $(this).dequeue(); } );
